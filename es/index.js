...
const COLLECTION_NAME_ALERT = toCollectionName(MODEL_NAME_ALERT);
...
export { COLLECTION_NAME_ACCOUNT, COLLECTION_NAME_ALERT, COLLECTION_NAME_CHANGELOG, COLLECTION_NAME_CONTENT, COLLECTION_NAME_ITEM, COLLECTION_NAME_JURISDICTION, COLLECTION_NAME_PARTY, COLLECTION_NAME_PERMISSION, COLLECTION_NAME_PREDEFINE, COLLECTION_NAME_PRIORITY, COLLECTION_NAME_ROLE, COLLECTION_NAME_SERVICE, COLLECTION_NAME_SERVICEGROUP, COLLECTION_NAME_SERVICEREQUEST, COLLECTION_NAME_SERVICETYPE, COLLECTION_NAME_STATUS, COLLECTION_NAME_ZONE, CONTACT_METHODS, CONTACT_METHODS_WEB, CONTACT_METHOD_EMAIL, CONTACT_METHOD_FAX, CONTACT_METHOD_LETTER, CONTACT_METHOD_MOBILE_APP, CONTACT_METHOD_PHONE_CALL, CONTACT_METHOD_SMS, CONTACT_METHOD_USSD, CONTACT_METHOD_VISIT, CONTACT_METHOD_WEBSITE, COUNTER_PAD_SIZE, COUNTER_PREFIX, COUNTER_YEAR_FORMAT, MODEL_NAME_ACCOUNT, MODEL_NAME_ALERT, MODEL_NAME_CHANGELOG, MODEL_NAME_CONTENT, MODEL_NAME_ITEM, MODEL_NAME_JURISDICTION, MODEL_NAME_PARTY, MODEL_NAME_PERMISSION, MODEL_NAME_PREDEFINE, MODEL_NAME_PRIORITY, MODEL_NAME_ROLE, MODEL_NAME_SERVICE, MODEL_NAME_SERVICEGROUP, MODEL_NAME_SERVICEREQUEST, MODEL_NAME_SERVICETYPE, MODEL_NAME_STATUS, MODEL_NAME_ZONE, PATH_NAME_ACCOUNT, PATH_NAME_ASSIGNEE, PATH_NAME_CONTENT, PATH_NAME_ITEM, PATH_NAME_JURISDICTION, PATH_NAME_OPERATOR, PATH_NAME_PARTY, PATH_NAME_PERMISSION, PATH_NAME_PRIORITY, PATH_NAME_ROLE, PATH_NAME_SERVICE, PATH_NAME_SERVICEGROUP, PATH_NAME_SERVICEREQUEST, PATH_NAME_SERVICETYPE, PATH_NAME_STATUS, PATH_NAME_ZONE, POPULATION_DEFAULT, POPULATION_MAX_DEPTH, PREDEFINE_BUCKET_BLOCKREASON, PREDEFINE_BUCKET_PRIORITY, PREDEFINE_BUCKET_SERVICE, PREDEFINE_BUCKET_SERVICEGROUP, PREDEFINE_BUCKET_SERVICETYPE, PREDEFINE_BUCKET_STATUS, PREDEFINE_NAMESPACE_BLOCKREASON, PREDEFINE_NAMESPACE_PRIORITY, PREDEFINE_NAMESPACE_SERVICE, PREDEFINE_NAMESPACE_SERVICEGROUP, PREDEFINE_NAMESPACE_SERVICETYPE, PREDEFINE_NAMESPACE_STATUS, RELATION_NAMES, RELATION_NAME_AGENCY, RELATION_NAME_APP, RELATION_NAME_CIVILIAN, RELATION_NAME_CUSTOMER, RELATION_NAME_INTERNAL, RELATION_TYPES, RELATION_TYPE_APP, RELATION_TYPE_INDIVIDUAL, RELATION_TYPE_ORGANIZATION, RELATION_TYPE_WORKER, VISIBILITIES, VISIBILITY_PRIVATE, VISIBILITY_PUBLIC, WORKSPACES, WORKSPACE_CALL_CENTER, WORKSPACE_CUSTOMER_CARE, WORKSPACE_OTHER, WORKSPACE_SURVEY, WORKSPACE_TECHNICAL, checkDependenciesFor, unlocalize };
