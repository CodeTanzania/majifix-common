...
/* contact methods */
export const CONTACT_METHOD_PHONE_CALL = 'Call';
export const CONTACT_METHOD_EMAIL = 'Email';
export const CONTACT_METHOD_SMS = 'SMS';
export const CONTACT_METHOD_USSD = 'USSD';
export const CONTACT_METHOD_VISIT = 'Visit';
export const CONTACT_METHOD_LETTER = 'Letter';
export const CONTACT_METHOD_FAX = 'Fax';
export const CONTACT_METHOD_MOBILE_APP = 'Mobile';
export const CONTACT_METHOD_WEBSITE = 'Website';
...
export const CONTACT_METHODS_WEB = [
  CONTACT_METHOD_PHONE_CALL,
  CONTACT_METHOD_EMAIL,
  CONTACT_METHOD_SMS,
  CONTACT_METHOD_VISIT,
